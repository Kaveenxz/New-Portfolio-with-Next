        ...
        <section className="w-full py-28">
            ...
            <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
                <Card 
                    ...
                    description="Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sequi illo, culpa repellat error vel odit quis harum natus nostrum consequatur magni fugiat dicta ad eum nesciunt et sed, a reprehenderit?           "
                >
                    <CanvasRevealEffect
                        animationSpeed={5.1}
...
const Card = ({
    ...
    return (
        <div
            ...
            className="border lg:h-[35rem] rounded-3xl border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 relative h-[30rem] relative"
        >
